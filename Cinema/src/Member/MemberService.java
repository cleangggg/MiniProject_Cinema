			...
			case 5:
				...
				case 1:
					...
					if (d3 == null) {
						...
						System.out.println("현재 비밀번호: " + d3.getMember_pwd());
						System.out.print("새로운 비밀번호 입력: ");
						pwd = input.next();

						d3.setMember_id(id);
						d3.setMember_pwd(pwd);
						db.change_pwd(d3);
				...
				case 2:
					...
					if (d4 == null) {
						...
						System.out.println("현재 전화번호: " + d4.getPhone());
				...
				case 3:
					...
					if (d5 == null) {
						...
						System.out.println("현재 닉네임: " + d5.getNick());
